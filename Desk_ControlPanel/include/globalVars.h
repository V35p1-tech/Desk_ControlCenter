...
//Screens
    ...
    extern const int Screen_1 = 1;  
    extern const int Screen_2 = 2;   
    extern const int Screen_3 = 3; 
//Rows Y
    extern int Row_Selected; 
    extern int Row_Height = 10; 

    extern const int Row_1 = 1;  
    extern const int Row_2 = 2;  
    extern const int Row_3 = 3;  
    extern const int Row_4 = 4;  
    extern const int Row_5 = 5;   
